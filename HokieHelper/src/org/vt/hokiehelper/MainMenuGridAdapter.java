...
public class MainMenuGridAdapter extends BaseAdapter {
	...
	private String[] text_ = { "Maps", "Dining", "News", "Football", "Rec Sports","Information" };
	private Integer[] images_ = { R.drawable.maps, R.drawable.dining, R.drawable.news, R.drawable.football, R.drawable.recsports, R.drawable.information };
